        ...
        <div>
            ...
            <h2 className="mb-0 pb-0 text-info text-uppercase fw-bolder fs-2 nav-heading pt-4" href="#"><span className="fs-1 text-black-50">A</span>bout <span className="fs-1 text-black-50">M</span>e</h2>
                <Row xs={1} md={2}>
                    ...
                    <Col className=" text-start d-flex align-items-center font-monospace bg-custom border border-5 rounded rounded-3 my-5 my-xm-2 mx-xm-2">
                        <div >
                            ...
                            <p>I love playing puzzle games. I am a sub'30 player of Rubik's Cube. I solve sudoku quite well. I am Tengram Lover.</p>
                        </div>
                    </Col>
